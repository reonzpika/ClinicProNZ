...
## 🎨 Final Layout (Option B - Revised 2025-10-31)

```
┌────────────────────────────────────────────────────────────────┐
│  [🔴][🔴][✅]  [Upload] [Camera] [QR]              [MOCK]     │ ← Row 1: Thumbnails + Upload controls
│                            ☐ Inbox  ☐ Task  [Commit All 2]    │ ← Row 2: Commit actions (right-aligned)
├────────────────────────────────────────────────────────────────┤
│  [Error Banner if any]                                         │ ← Optional
├────────────────────────────────────────────────────────────────┤
│  [QR Code Panel - collapsible]                                │ ← Optional
├────────────────────────────────────────────────────────────────┤
│                                                                 │
│  [< Prev] [Next] [Edit]      Zoom: [−] 100% [+] [Reset]       │ ← Image controls at top
│  ┌──────────────────┐                                          │
│  │                  │  Metadata                                │
│  │  Image Preview   │  ─────────                              │
│  │                  │  Laterality *                            │
│  │    (30%)         │  [Left] [Right] [Bilateral]             │
│  │                  │                                          │
│  │                  │  Body Site *                             │
│  │                  │  [Forearm ▼]                             │
│  └──────────────────┘                                          │
