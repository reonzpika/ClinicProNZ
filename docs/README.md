...
- **No Direct Edits**: AI agent must not edit any documentation files directly
- **Request Changes**: All documentation changes must be requested from the developer
- **Explain Changes**: Provide clear reasoning for any suggested documentation updates
- **Maintain History**: Keep track of documentation changes in the todo list
...
1. **Start with Project Fundamentals**
   ...
   - Consult `project/todo.md` for current development progress
...
3. Request approval from the developer
4. Update the todo list if approved
5. Follow the existing structure and format
