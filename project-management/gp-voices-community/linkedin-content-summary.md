# LinkedIn Weekly Content - Validation Experiment
...
### Week 2: 2025-11-15 (Planned)

**Status**: News curation in progress  
**Target Post Date**: Tuesday-Thursday, 8-9am or 5-6pm NZST

**News Items**: [To be collected]
...
**Templates & Workflows**:
- `linkedin-weekly-workflow.md` - Reusable workflow for creating posts
...
**Immediate (Week 2)**:
1. Collect 3-5 news items for this week's post
2. Analyse Week 1 new followers (GP vs vendor ratio)
3. Draft and post Week 2 content
4. Track audience quality in engagement
