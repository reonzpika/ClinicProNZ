...
**Summary**: [1 sentence - what happened and why it matters to GPs]
...
3. [Item 3 description]: [URL]

[@Mentions - select 2-4 relevant mentions]

[#Hashtags - select 5-8 hashtags mixing evergreen + trending + NZ-specific]
```
...
*Template for weekly LinkedIn posts - copy this file each week*
