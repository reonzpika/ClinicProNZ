...
### 1. Curate News (15-20 min)

**Sources**:
- BPAC: https://bpac.org.nz/
- NZ Doctor: https://www.nzdoctor.co.nz/
- Pharmac: https://www.pharmac.govt.nz/news-and-resources/news/
- HQSC: https://www.hqsc.govt.nz/
- Ministry of Health: https://www.health.govt.nz/
- Medical Council: https://www.mcnz.org.nz/
...
**The big picture**: [1-2 sentences: Common theme or takeaway across these items]

**Are you using [relevant topic] in your practice?** What's working — or not working — for you? Share your experience in the comments 👇
...
**References:**
1. [Item 1 description]: [URL]
2. [Item 2 description]: [URL]
[Continue numbering]

[@Mentions - see Mentions section below]
...
**Prompt**:
```
Create a professional LinkedIn post image (1200x1200px square format) with bold text overlay.

Design specifications:
- Background: Deep blue gradient (#1e3a8a to #0ea5e9) with subtle geometric patterns suggesting AI/technology
- Style: Modern, clean, professional healthcare aesthetic
...
Visual elements:
- Subtle circuit/neural network patterns in background (very light, not distracting)
- Small New Zealand fern or koru pattern integrated subtly
- Clean, modern sans-serif font (Inter, Poppins, or similar)
- Text with subtle shadow or outline for readability

Style: Eye-catching but professional. Suitable for healthcare professionals on LinkedIn. 
High contrast between text and background. Modern, trustworthy aesthetic.
```
...
**Posting Time**: Tuesday-Thursday, 8-9am or 5-6pm NZST
...
Use 2-4 mentions per post. Tag when content directly relates to them.

**Common Mentions**:
- @Medtech Global (PMS/digital health)
- @Health New Zealand - Te Whatu Ora (national health policy)
- @Health Informatics New Zealand (HiNZ) (digital health/informatics)
- @RNZCGP (GP standards/training)
...
Use 5-8 hashtags per post. Mix evergreen + trending + NZ-specific.
