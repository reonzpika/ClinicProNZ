# Capability Development Objectives - Forge Portal Format

**Total CapDev:** $36,000 (5.02% of total eligible costs)
**Categories:** 3 objectives (meets "minimum 2" requirement)

---

## Objective CD-1: Regulatory & Compliance Capability for NZ Health AI
...
**Knowledge Transfer Method:** Third-party experts (privacy/DPIA specialists, clinical safety consultants, regulatory advisers) provide training through gap analysis, DPIA development, safety advisory sessions, and ongoing compliance guidance. Each engagement builds practical skills in handling real compliance challenges. Frameworks and templates created become reusable organizational knowledge.
...
## Objective CD-2: R&D Information Management for Systematic Research
...
## Objective CD-3: R&D Project Management Capability for First-Time R&D Performer
...
## Notes for Forge Portal Entry:

### Objective Titles (use exactly as written):
1. **Regulatory & Compliance Capability for NZ Health AI**
2. **R&D Information Management for Systematic Research**
3. **R&D Project Management Capability for First-Time R&D Performer**

### Start Dates (all same):
- 27 February 2026 (Month 2 of project)

### End Dates:
- CD-1: 26 July 2027 (Month 18)
- CD-2: 26 September 2026 (Month 8)
- CD-3: 26 June 2027 (Month 16)
...
- ✅ Each objective clearly states **current capability gap** and **what will be gained**
