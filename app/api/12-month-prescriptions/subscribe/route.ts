...
const NEWSLETTER_KEY = '12-month-prescriptions';

/**
 * POST /api/12-month-prescriptions/subscribe
 *
 * Public route. Adds email as a Clerk user with newsletter metadata so they
 * appear in Clerk Dashboard as 12-month-prescriptions subscribers.
 */
export async function POST(req: NextRequest) {
  try {
    ...
    console.error('[12-month-prescriptions/subscribe] Error:', err);
    return NextResponse.json(
