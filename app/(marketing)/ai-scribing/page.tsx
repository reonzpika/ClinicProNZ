                ...
                <div className="space-y-6">
                  ...
                  <div className="rounded-lg border-l-4 border-orange-500 bg-orange-50 p-4">
                    ...
                    <p className="text-orange-700">
                      AI can struggle with accents, jargon, and local languages like te reo MÄori. Some platforms are noted as being particularly poor at capturing te reo MÄori. One user experienced the tool misattributing information to a patient when trying to build rapport using whakawhanaungatanga.
                    </p>
                  </div>
