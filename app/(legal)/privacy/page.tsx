              ...
              <div className="space-y-8">
                ...
                <section>
                  ...
                  <p className="mt-4 leading-relaxed text-gray-700">
                    ...
                    and ethical use of the service in accordance with New Zealand privacy and health information laws.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <ul className="list-disc space-y-2 pl-6 text-gray-700">
                    <li>
                      ...
                      {' '}
                      Patients can request access to their health information.
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      {' '}
                      Patients can complain to the Privacy Commissioner if they believe their privacy has been breached.
                    </li>
                    <li>
                      <strong>Right to Withdraw Consent:</strong>
                      {' '}
                      Patients can withdraw their consent for the use of AI tools at any time.
                    </li>
                  </ul>
                  <p className="mt-4 leading-relaxed text-gray-700">
                ...
                <section>
                  ...
                  <ul className="list-disc space-y-2 pl-6 text-gray-700">
                    <li>You must assess whether the breach is likely to cause serious harm to the affected individuals.</li>
                    <li>If serious harm is likely, you must notify the Privacy Commissioner as soon as practicable.</li>
                    <li>You must also notify affected individuals if the breach is likely to cause serious harm.</li>
                    <li>You should document the breach and your response for future reference.</li>
                  </ul>
                  <p className="mt-4 leading-relaxed text-gray-700">
                ...
                <section>
                  ...
                  <p className="leading-relaxed text-gray-700">
                    This Privacy Policy is designed to comply with the New Zealand Privacy Act 2020 and the Health Information Privacy Code 2020. If you have concerns about our compliance with these laws, you may contact the Office of the Privacy Commissioner at
                    {' '}
                    <a href="https://www.privacy.org.nz" className="text-blue-600 hover:text-blue-800">
                      www.privacy.org.nz
                    </a>
                    .
                  </p>
                ...
                <div className="rounded-lg bg-blue-50 p-6">
                  <p className="text-lg font-medium text-blue-900">
                    We are committed to protecting your privacy and the privacy of your patients. By using ConsultAI NZ responsibly and in accordance with New Zealand law, we can work together to improve healthcare delivery while maintaining the highest standards of privacy protection.
                  </p>
                </div>
              </div>
            </div>
