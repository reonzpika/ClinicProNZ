...
const mainNavItems: NavItem[] = [
  ...
  { href: '/clinical-reference', label: 'Clinical Reference', icon: Book },
  { href: '/differential-diagnosis', label: 'Differential Diagnosis', icon: Brain },
  { href: '/clinical-image', label: 'Clinical Images', icon: Camera },
];
