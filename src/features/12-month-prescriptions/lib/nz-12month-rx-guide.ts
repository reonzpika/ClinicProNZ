...
## 🔑 KEY FINDING FOR PRESCRIBERS

**The legislation grants YOU full clinical discretion.** There are NO mandatory patient eligibility criteria in law. The "eligibility frameworks" you'll see are professional guidance to help you make safe decisions—they are NOT legal requirements.

### Understanding the Markers in This Document

| Marker | Meaning | Source of Authority |
|--------|---------|-------------------|
| 🔴 **LEGAL REQUIREMENT** | You MUST comply | Medicines Regulations 2025, Misuse of Drugs Act 1975, Pharmac Schedule Rules |
| 🟡 **PROFESSIONAL STANDARD** | Required for RNZCGP accreditation | RNZCGP Foundation Standard 9.1 |
| 🟢 **GUIDANCE** | Recommended best practice (discretionary) | RNZCGP Position Statement, Healthify, professional bodies |
| 🔵 **PRACTICE DECISION** | Individual practice implementation | Early adopter practices, PHO guidance |
...
🔴 **LEGAL REQUIREMENT**: From 1 February 2026, prescriptions may be written for up to **12 months** (increased from 3 months for most medicines, 6 months for oral contraceptives).
**SOURCE:** Medicines (Increasing the Period of Supply) Amendment Regulations 2025 (SL 2025/203)

🔴 **LEGAL REQUIREMENT**: Dispensing limits remain **unchanged** - pharmacies can still only dispense a maximum of **3 months' supply** per occasion (6 months for oral contraceptives).
**SOURCE:** Medicines Regulations 2025, Regulation 42(3)(d)

🔴 **LEGAL REQUIREMENT**: Prescriptions must be first presented to a pharmacy **within 3 months** of the issue date.
**SOURCE:** Medicines Regulations 2025, Regulation 42(3)(c)

### Who Decides Clinical Appropriateness

🔴 **LEGAL REQUIREMENT**: The **prescriber** has full discretion to determine appropriate prescription duration based on individual patient assessment.
**SOURCE:** Medicines Regulations 2025; Ministry of Health Regulatory Impact Statement (21 November 2024)

🟢 **GUIDANCE**: Government guidance suggests prescribers would consider 12-month prescriptions for patients with "ongoing, stable health conditions" but does not mandate criteria.
**SOURCE:** Ministry of Health RIS, page 15

### Cost Implications

🔴 **LEGAL REQUIREMENT**: Patients pay **one prescription co-payment** ($5 for most) when first collecting their medicine. No additional co-payments for subsequent 3-monthly dispensings within that 12-month period.
**SOURCE:** Ministry of Health; Te Whatu Ora guidance

Standard co-payment exemptions apply (under 14, 65+, Community Services Card holders).
...
🟢 **GUIDANCE**: Same pharmacy requirement appears in operational guidance and patient materials but is not explicitly stated in Schedule Rules (may be system limitation).
**SOURCE:** Healthify patient information; RNZCGP patient materials
...
🔴 **LEGAL REQUIREMENT**: If a Special Authority expires before the 12-month prescription period ends, the prescriber must renew the Special Authority before further funded repeats can be dispensed.
**SOURCE:** Pharmac Schedule Rule 2.4.3 (amended October 2025)
...
🟢 **GUIDANCE**: RNZCGP patient materials suggest patients "may be eligible" if their condition and medication dose have been **stable for at least 6 months**.
**SOURCE:** RNZCGP Patient Poster and FAQs (January 2026)
...
🔵 **PRACTICE DECISION**: Individual practices may adopt this as policy or use different timeframes (some early adopters trialing 9-month prescriptions).

### Review Requirements

🟡 **PROFESSIONAL STANDARD**: Practices accredited under RNZCGP Foundation Standard must ensure **minimum annual review** for patients on 12-month prescriptions.
**SOURCE:** RNZCGP Foundation Standard 9.1 (updated 01/11/25)

🟢 **GUIDANCE**: RNZCGP Position Statement recommends "continuity of care: consider attendance at reviews and follow-ups—a minimum of annual review is required, or earlier if clinically indicated."
**SOURCE:** RNZCGP Position Statement, November 2025, page 3

🔵 **PRACTICE DECISION**: Some practices require face-to-face appointments for issuing 12-month prescriptions (e.g., The Doctors Napier).
**SOURCE:** NZ Herald, 1 February 2026
...
🔵 **PRACTICE DECISION**: Your practice should develop its own list of medications requiring shorter prescription intervals based on monitoring needs and patient risk factors.
...
**NOTE on statins:** 
🟢 **GUIDANCE**: BPAC guidance suggests routine LFT monitoring is not required for patients stable on statins.
**SOURCE:** BPAC Best Practice Journal
...
**NOTE:** Special Authority renewal requirements for LAMA/LABA combinations were removed by Pharmac in December 2025.
**SOURCE:** Pharmac announcement, December 2025

**Contraceptives:**
🔴 **LEGAL REQUIREMENT**: Oral contraceptives can be prescribed for 12 months and dispensed in 6-month intervals (increased from previous 6-month prescription limit).
**SOURCE:** Medicines Regulations 2025
...
- eGFR <45 mL/min/1.73m² (increased risk of renal deterioration, hyperkalemia)
...
🟢 **GUIDANCE**: Consider shorter intervals if:
- eGFR <45 mL/min/1.73m² (dose adjustment required)
...
- eGFR <50 mL/min/1.73m² (dose adjustment required; increased monitoring needed)
...
🟡 **PROFESSIONAL STANDARD**: RNZCGP Foundation Standard requires "annual reviews are a minimum, but more frequent assessments may be necessary based on patient condition and medication risks."
**SOURCE:** RNZCGP Foundation Standard 9.1

🟢 **GUIDANCE**: Telehealth/phone reviews may be acceptable for stable patients between in-person reviews, at prescriber discretion.
**SOURCE:** RNZCGP Position Statement
...
🟢 **GUIDANCE**: Consider 6-monthly reviews rather than annual for medication reconciliation and adverse effect screening.
**SOURCE:** RNZCGP Position Statement
...
🔵 **PRACTICE DECISION**: The following workflows are examples from early adopter practices. Your practice should develop its own process.
...
🔵 **PRACTICE DECISION**: Some practices using consent forms or patient information leaflets.
...
**"Can I get all my medicines for 12 months at once?"**
🔴 **LEGAL REQUIREMENT**: No. Pharmacies can only dispense 3 months at a time (6 months for oral contraceptives). You'll collect repeats every 3 months from the same pharmacy.

**"Will I still need to see my doctor?"**
🟢 **GUIDANCE**: Yes. RNZCGP recommends annual review as minimum. Your doctor will decide appropriate review frequency based on your health needs.

**"Why can't I get a 12-month prescription?"**
Explain using appropriate marker:
- 🔴 If controlled drug: "This medication is a controlled drug and legally cannot be prescribed for more than [1 or 3] months"
...
**"My friend got a 12-month prescription, why can't I?"**
🔴 **LEGAL REQUIREMENT**: "The law gives me discretion to determine the appropriate prescription length for each patient individually based on their specific health needs."
...
**Resolution:** Te Whatu Ora agreed (November 2025) to fund pharmacies "as if they were still delivering them under 3-month prescription pricing terms."
**SOURCE:** Pharmacy Guild press release, 13 November 2025
...
🔵 **CONTEXT**: International evidence provides context but does NOT determine NZ legal requirements or professional standards.
...
- Cost savings: £8.38-£12.06 per prescription per 120 days
...
- [ ] Condition stable ≥6 months? (patient materials suggest this)
- [ ] Medication dose stable ≥6 months?
...
**Government:**
- Ministry of Health: https://www.health.govt.nz/strategies-initiatives/programmes-and-initiatives/primary-and-community-health-care/increasing-prescribing-lengths
- Medicines Regulations 2025: https://www.legislation.govt.nz/regulation/public/2025/0203/
- Pharmac decision: https://www.pharmac.govt.nz/news-and-resources/consultations-and-decisions/2025-10-decision-on-changes-to-support-increased-prescription-lengths

**RNZCGP:**
- Position Statement: https://www.rnzcgp.org.nz/documents/657/12-month-prescribing-position-statement-NOV-2025.pdf
- Foundation Standard 9.1: https://www.rnzcgp.org.nz/running-a-practice/the-foundation-standard/whakahau-rongoa-medicines-management/91-repeat-prescribing/
- Patient resources: https://www.rnzcgp.org.nz/our-voice/hot-topics/12-month-prescriptions/

**Consumer Information:**
- Healthify: https://healthify.nz/medicines-a-z/p/12-month-prescriptions

**Practice Implementation:**
- Pinnacle Practices: https://www.pinnaclepractices.co.nz/resources/12-month-prescribing/
...
\`\`\`
┌─────────────────────────────────────────────────────────────────┐
│  🔴 TIER 1: LEGAL REQUIREMENTS (MUST COMPLY)                    │
│  You have no discretion - these are legally binding             │
└─────────────────────────────────────────────────────────────────┘
        ↓
┌─────────────────────────────────────────────────────────────────┐
│  🟡 TIER 2: PROFESSIONAL STANDARDS (REQUIRED FOR ACCREDITATION) │
│  Mandatory if your practice is RNZCGP-accredited                │
└─────────────────────────────────────────────────────────────────┘
        ↓
┌─────────────────────────────────────────────────────────────────┐
│  🟢 TIER 3: PROFESSIONAL GUIDANCE (RECOMMENDED)                 │
│  Best practice recommendations - you have discretion            │
└─────────────────────────────────────────────────────────────────┘
        ↓
┌─────────────────────────────────────────────────────────────────┐
│  🔵 TIER 4: INDIVIDUAL PRACTICE DECISIONS                       │
│  Your practice determines implementation details                │
└─────────────────────────────────────────────────────────────────┘
\`\`\`
...
|-------------|-------------------|
| ✓ Have a **documented repeat prescribing policy** that includes clear criteria for when 12-month prescriptions are appropriate | Required now |
| ✓ Conduct **annual audits** of repeat prescribing | Annually |
| ✓ **Differentiate Māori from non-Māori** in audit results to identify inequities | Each audit |
| ✓ Take improvement actions if audits show non-compliance | As needed |
| ✓ Ensure **minimum annual review** for patients on repeat prescriptions | Ongoing |
| ✓ Include "additional measures to **optimise Māori access**" in policy | Required now |
| ✓ **Do NOT issue repeats** to patients who need examination without seeing them | Ongoing |
...
| ❌ MISCONCEPTION | ✅ REALITY | Authority Level |
|-----------------|-----------|----------------|
...
| "I must issue 12-month prescriptions if patients ask" | You have full discretion to issue shorter durations | 🔴 LAW (discretion granted) |
...
### MUST (🔴 Legal or 🟡 Standard for accredited practices):
- ✓ Not prescribe controlled drugs for >1-3 months
- ✓ Ensure Special Authority valid for funded repeats
- ✓ Have documented repeat prescribing policy (if accredited)
- ✓ Conduct annual audits with Māori/non-Māori differentiation (if accredited)
- ✓ Not issue repeats without seeing patients who need examination (if accredited)

### SHOULD CONSIDER (🟢 Guidance):
- ✓ Is condition stable? (you define "stable")
- ✓ Does medication require regular monitoring?
- ✓ Is patient in higher-risk group? (age, polypharmacy, etc.)
- ✓ Will patient attend annual review?
- ✓ Equity considerations for this patient

### CAN DECIDE (🔵 Practice):
- ✓ Use 6, 9, or 12 months based on your clinical judgment
- ✓ Require face-to-face or allow phone/video
- ✓ Use consent forms or just document in notes
- ✓ Set your own "stability" criteria
...
- **Legal question?** → Check Medicines Regulations 2025
- **Accreditation question?** → Check RNZCGP Foundation Standard 9.1
- **Clinical question?** → Use your professional judgment with RNZCGP guidance
- **Practice implementation question?** → Decide what works for your practice
