...
import { MULTIPROBLEM_SOAP_UUID, useConsultation } from '@/shared/ConsultationContext';
...
export const DocumentationSettingsBadge: React.FC = () => {
  ...
  }, [templates, isInitialLoad]); // Removed templateId and inputMode from dependencies
