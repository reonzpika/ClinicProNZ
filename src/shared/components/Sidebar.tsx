...
const mainNavItems: NavItem[] = [
  ...
  { href: '/ai-scribe/image', label: 'Clinical Images', icon: Camera, requiresAuth: true },
          ...
          <div className="flex-none p-3">
            ...
            <div className="space-y-1">
              {mainNavItems
                ...
                .map(item => (
                  <NavButton key={item.href} item={item} isCollapsed={isCollapsed} onClick={handleNavClick} />
                ))}
            </div>
          </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="rounded-lg bg-white p-6 shadow-lg">
            ...
            <div className="flex justify-center gap-3">
              <SignInButton mode="modal">
                <button type="button" className="rounded-md border border-slate-400 px-3 py-1 text-sm text-slate-700 hover:bg-slate-50">
                  Sign In
                </button>
              </SignInButton>
              <SignUpButton mode="modal">
                <button type="button" className="rounded-md bg-slate-700 px-3 py-1 text-sm text-white hover:bg-slate-800">
                  Sign Up
                </button>
              </SignUpButton>
              <button
