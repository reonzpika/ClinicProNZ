      ...
      <div className="relative mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-start lg:gap-20">
              ...
              <div className="hover:shadow-3xl group relative overflow-hidden rounded-3xl border-2 border-nz-green-200/50 bg-white shadow-2xl transition-all duration-300 hover:-translate-y-1">
                ...
                <div className="relative z-10 p-8 text-center">
                  ...
                  <p className="text-sm text-gray-500">
                    Discount locked for 12 months • Cancel anytime
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="lg:mt-8">
            <div className="w-full rounded-2xl border-2 border-nz-blue-200/50 bg-gradient-to-r from-nz-blue-50/80 to-nz-green-50/60 p-8 shadow-lg">
              <h4 className="mb-6 text-2xl font-bold text-nz-blue-900 lg:text-3xl">Why the discount?</h4>
              <p className="mb-8 text-lg leading-relaxed text-nz-blue-800 lg:text-xl">
                ClinicPro is early-stage. Your real-world feedback is invaluable. This pricing is my thank you for helping build something bigger.
              </p>

              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="mt-3 size-2 shrink-0 rounded-full bg-nz-green-600"></div>
                  <div>
                    <h5 className="mb-1 text-xl font-bold text-nz-green-600">Direct line to founder</h5>
                    <p className="text-base text-gray-700">Your feedback shapes every feature update</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="mt-3 size-2 shrink-0 rounded-full bg-nz-green-600"></div>
                  <div>
                    <h5 className="mb-1 text-xl font-bold text-nz-green-600">Weekly progress updates</h5>
                    <p className="text-base text-gray-700">See your suggestions come to life in real-time</p>
                  </div>
                </div>
              </div>
            </div>
